...
class Transformer(nn.Module):
    ...
    #TODO forward
    def forward(self, src, query, mask, query_embed, pos_embed):
        ...
        return hs.squeeze(0), memory.permute(1, 2, 0).view(bs, c, h, w)
...
def build_transformer(args):
    return Transformer(
        ...
        num_encoder_layers=args.rpe_enc_layers,
        num_decoder_layers=args.rpe_dec_layers,
