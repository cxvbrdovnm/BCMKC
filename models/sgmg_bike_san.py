...
# from .bike import san_bike
from .san import fuse, san_bike
...
class SgMg(nn.Module):
    ...
    def __init__(self, args, backbone, transformer, num_classes, num_queries, num_feature_levels,
        ...
        self.san_bike = san_bike(backbone_name, args)
        self.fuse = fuse(256)
    ...
    def forward(self, samples: NestedTensor, captions, targets):
        ...
        # todo
        # clip_features = self.san_bike(samples, t)
        ...
        for lvl in range(hs.shape[0]):
            ...
            # print(outputs_seg_mask.shape) #1 25 16 28 24
