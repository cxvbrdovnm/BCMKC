...
class TMEMBlock(nn.Module):
    def __init__(self, dim, channels, mlp_ratio=2):
        ...
        # v_in_channels, l_in_channels, key_channels, value_channels, out_channels=None, num_heads=1
        self.tma = SpatialImageLanguageAttention(dim, dim, dim, dim, num_heads=8)
