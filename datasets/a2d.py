...
def make_coco_transforms(image_set, max_size=640, model_name=""):
    normalize = T.Compose([
        T.ToTensor(),
    ...
    if image_set == 'val':
        return T.Compose([
            T.RandomResize([360], max_size=max_size),
            normalize,
        ])
...
def build(image_set, args):
    ...
    dataset = A2DSentencesDataset(img_folder, ann_file, transforms=make_coco_transforms(image_set, max_size=args.max_size, model_name=args.model_name),
