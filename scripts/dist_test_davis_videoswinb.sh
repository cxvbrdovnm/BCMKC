...
MODEL_NAME="SgMg_bike_Sv_Sa_220"
#CHECKPOINT="./checkpoints/sgmg_videosiwnb_ytvos.pth"
CHECKPOINT="./checkpoints/results/0_SgMg_bike_0409_video_swin_b_p4w7_finetune/checkpoint0011.pth"
OUTPUT_DIR="./checkpoints/results/davis/${MODEL_NAME}_${BACKBONE}_eval"
