...
PRETRAINED_WEIGHT="./checkpoints/results/sgmg_videoswinb_refcoco.pth"
#PRETRAINED_WEIGHT="./checkpoints/results/SgMg_san_1113_video_swin_b_p4w7_finetune/checkpoint0008.pth"
MODEL_NAME="SgMg_test"
OUTPUT_DIR2="./checkpoints/results/${MODEL_NAME}_${BACKBONE}_finetune"
EXP_NAME2="${MODEL_NAME}_${BACKBONE}_finetune"
